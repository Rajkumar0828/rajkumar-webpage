...
const socialLinks = [
    {
        href: 'https://github.com/Rajkumar0828',
    ...
    {
        href: 'https://www.linkedin.com/in/rajkumar-ramanathan-8b0944208/',
        icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <section id="contact" className="section">
            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        ...
                        (
                            <a
                                ...
                                href={href}
                                target="_blank"
                                className="place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg 
                ...
                <form action="https://getform.io/f/akkkgoga"
                    method="POST"
                    ...
                    <div className="mb-4">
                        ...
                        placeholder="Hi!"
                        required
                        className="text-field resize-y min-h-2 max-h-80 reveal-up"
                        >
